...
export default function CollegeDashboard() {
  ...
  useEffect(() => {
    async function fetchProfile() {
      try {
        // 🔴 FIX: Changed from "/api/profile" to "/api/college/profile"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6 lg:p-8">
          {/* Header with College Name and Badge */}
          <div className="mb-8">
          ...
          {/* Quick Actions and College Info */}
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() => router.push("/college/reports")}
                    className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-all w-full"
                  >
