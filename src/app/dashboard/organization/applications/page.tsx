      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6 lg:p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-400">Review and manage volunteer applications for your events</p>
          </div>
          ...
          {loading ? (
            ...
            <Card>
              <CardContent className="text-center py-16">
                ...
                <p className="text-gray-400">Applications will appear here when volunteers apply to your events</p>
              </CardContent>
            </Card>
          ) : (
            <div className="space-y-3">
                    ...
                    <CardContent className="p-0">
                      ...
                      >
                        ...
                        <div className="text-right shrink-0 flex items-center gap-3">
                          <span className="text-xs text-gray-500 hidden sm:block">{formatDate(app.appliedAt)}</span>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-3">
                              <h4 className="font-semibold text-white text-sm flex items-center gap-2">
                                <User className="w-4 h-4 text-indigo-400" /> Applicant Details
                              </h4>
                              ...
                              {app.message && (
                                <div>
                                  ...
                                  <p className="text-sm text-gray-300 bg-white/5 p-2 rounded">{app.message}</p>
                                </div>
                              )}
                              ...
                              {app.team && (
                                <div>
                                  ...
                                  <p className="text-sm font-medium text-white">{app.team.name}</p>
                                </div>
                              )}
                            </div>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {app.status === "APPLIED" && (
                                  <>
                                    <Button size="sm" variant="outline" onClick={() => updateApplicationStatus(app.id, "SHORTLISTED")} className="gap-1">
                                      <Clock className="w-3.5 h-3.5" /> Shortlist
                                    </Button>
                                    <Button size="sm" onClick={() => updateApplicationStatus(app.id, "ACCEPTED")} className="gap-1">
                                      <CheckCircle2 className="w-3.5 h-3.5" /> Accept
                                    </Button>
                                    <Button size="sm" variant="danger" onClick={() => updateApplicationStatus(app.id, "REJECTED")} className="gap-1">
              ...
              {totalPages > 1 && (
                <div className="flex justify-center gap-2 mt-6">
                  ...
                  <span className="flex items-center px-4 text-sm text-gray-400">Page {page} of {totalPages}</span>
